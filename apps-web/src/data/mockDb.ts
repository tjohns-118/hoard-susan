...
tags: ['investor', 'warm'],
buyerProfile: { targetArea: 'Fredericksburg, TX', priceMin: 2000000, priceMax: 3000000, propertyType: 'ranch', tags: ['investor'] },
buyerAreaKeys: ['tx:fredericksburg'],
sellerAreaKeys: [],
...
tags: ['buyer'],
buyerProfile: { targetArea: 'Kerrville, TX', priceMin: 1500000, priceMax: 2200000, propertyType: 'ranch', tags: [] },
buyerAreaKeys: ['tx:kerrville', 'tx:kerr_county'],
sellerAreaKeys: [],
newsletterOptIn: false,
newsletterTags: [],
...
buyerProfile: { targetArea: 'Kerrville, TX', priceMin: 1500000, priceMax: 3500000, propertyType: 'ranch', tags: ['investor', 'luxury_preference'] },
buyerAreaKeys: ['tx:kerrville', 'tx:kerr_county'],
sellerAreaKeys: [],
newsletterOptIn: false,
newsletterTags: [],
...
tags: ['hot', 'buyer'],
buyerProfile: { targetArea: 'Kerrville, TX', priceMin: 1500000, priceMax: 2000000, propertyType: 'ranch', tags: [] },
buyerAreaKeys: ['tx:kerrville', 'tx:kerr_county'],
sellerAreaKeys: [],
newsletterOptIn: false,
newsletterTags: [],
...
tags: ['social', 'warm'],
buyerProfile: { targetArea: 'Fredericksburg, TX', priceMin: 2000000, priceMax: 2800000, tags: [] },
buyerAreaKeys: ['tx:fredericksburg'],
sellerAreaKeys: [],
newsletterOptIn: false,
newsletterTags: [],
...
tags: ['warm', 'buyer'],
buyerProfile: { targetArea: 'Kerrville, TX', priceMin: 1200000, priceMax: 2000000, propertyType: 'ranch', tags: [] },
buyerAreaKeys: ['tx:kerrville', 'tx:kerr_county'],
sellerAreaKeys: [],
newsletterOptIn: false,
newsletterTags: [],
...
buyerProfile: { targetArea: 'Fredericksburg, TX', priceMin: 2200000, priceMax: 3200000, tags: ['investor'] },
buyerAreaKeys: ['tx:fredericksburg'],
sellerAreaKeys: [],
newsletterOptIn: false,
newsletterTags: [],
...
tags: ['investor'],
buyerProfile: { targetArea: 'Kerrville, TX', priceMin: 1500000, priceMax: 3000000, tags: ['investor', '1031_exchange'] },
buyerAreaKeys: ['tx:kerrville', 'tx:kerr_county'],
sellerAreaKeys: [],
newsletterOptIn: false,
newsletterTags: [],
...
opportunities: [
{
  ...
  documents: [],
  stageHistory: [{ fromStage: '', toStage: 'lead_received', changedAt: '2026-03-28T10:00:00.000Z' }],
  value: 1850000, valueMin: 1850000,
  probability: 15,
...
},
{
  ...
  stageOwner: 'agent' as const,
  documents: [],
  stageHistory: [{ fromStage: '', toStage: 'lead_received', changedAt: '2026-03-29T14:00:00.000Z' }, { fromStage: 'lead_received', toStage: 'qualified_buyer', changedAt: '2026-03-30T09:00:00.000Z' }],
  value: 950000, valueMin: 950000,
  probability: 10,
...
},
{
  ...
  stageHistory: [{ fromStage: '', toStage: 'lead_received', changedAt: '2026-03-31T09:00:00.000Z' }, { fromStage: 'lead_received', toStage: 'preapproved', changedAt: '2026-04-02T09:00:00.000Z' }],
  value: 1850000, valueMin: 1850000,
  probability: 35,
...
},
{
  ...
  stageOwner: 'agent' as const,
  documents: [],
  stageHistory: [{ fromStage: '', toStage: 'lead_received', changedAt: '2026-03-30T11:00:00.000Z' }, { fromStage: 'lead_received', toStage: 'touring', changedAt: '2026-03-31T08:00:00.000Z' }],
  value: 2400000, valueMin: 2400000,
  probability: 40,
...
},
{
  ...
  stageOwner: 'agent' as const,
  documents: [],
  stageHistory: [{ fromStage: '', toStage: 'lead_received', changedAt: '2026-03-25T10:00:00.000Z' }, { fromStage: 'lead_received', toStage: 'offer_prepared', changedAt: '2026-04-01T14:00:00.000Z' }],
  value: 2400000, valueMin: 2400000,
  probability: 65,
...
},
{
  ...
  stageHistory: [{ fromStage: '', toStage: 'under_contract', changedAt: '2026-04-04T10:00:00.000Z' }, { fromStage: 'under_contract', toStage: 'repair_negotiation', changedAt: '2026-04-05T10:00:00.000Z' }],
  stageUpdatedAt: '2026-04-05T10:00:00.000Z',
  value: 2950000, valueMin: 2950000,
  probability: 80,
...
},
{
  ...
  stageOwner: 'agent' as const,
  documents: [],
  stageHistory: [{ fromStage: '', toStage: 'closed', changedAt: '2026-03-20T16:00:00.000Z' }],
  value: 2400000, valueMin: 2400000,
  probability: 100,
...
},
{
  ...
  stageOwner: 'agent' as const,
  documents: [],
  stageHistory: [{ fromStage: '', toStage: 'lost', changedAt: '2026-03-15T12:00:00.000Z' }],
  value: 750000, valueMin: 750000,
  probability: 0,
...
properties: [
{
  ...
  acreage: 340,
  assignedAgentId: 'agent_1',
  areaKeys: ['tx:kerr_county', 'tx:kerrville'],
...
},
{
  ...
  acreage: 85,
  assignedAgentId: 'agent_2',
  areaKeys: ['tx:gillespie_county', 'tx:fredericksburg'],
...
},
{
  ...
  acreage: 520,
  assignedAgentId: 'agent_1',
  areaKeys: ['tx:bandera_county', 'tx:bandera'],
...
},
{
  ...
  acreage: 180,
  assignedAgentId: undefined,
  areaKeys: ['tx:llano_county', 'tx:llano'],
  linkedContactIds: [],
